...
export function Conditioner({hair, basketProductsQuantity, setBasketProductsQuantity}) {
  let res = hair.filter(el=> el.category == 'conditioners');
