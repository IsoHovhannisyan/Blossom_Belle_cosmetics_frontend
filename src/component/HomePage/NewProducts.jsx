        ...
        >
            {
                ...
                <button className='btn_text' id={index + props.indexForNewProducts} onClick={()=> navigate(`/product?path=${el.path}&id=${el.id}`)}>
                  {el.btn_text}
                </button>
                <div className='shopping' id={index + props.indexForNewProducts}>
                  <i className=' fa-solid fa-bag-shopping' onClick={()=> handleShoppingClick(el)}></i>
                </div>
                <div className='heart' id={index + props.indexForNewProducts} onClick={() => handleHeartClick(el.image)}>
