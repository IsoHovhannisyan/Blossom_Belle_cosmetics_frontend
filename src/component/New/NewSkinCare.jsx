...
export function NewSkinCare({skincare, basketProductsQuantity, setBasketProductsQuantity}) {
  const Skincare = skincare.filter(el=> el.new == 'true');
