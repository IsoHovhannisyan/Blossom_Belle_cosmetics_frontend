...
export function FaceBrushes({brush, basketProductsQuantity, setBasketProductsQuantity}) {
  let res = brush.filter(el=> el.category == 'Face Brushes');
