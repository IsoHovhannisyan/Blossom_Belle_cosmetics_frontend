...
export function LipBrushes({brush, basketProductsQuantity, setBasketProductsQuantity}) {
    let res = brush.filter(el=> el.category == 'Lip Brushes');
